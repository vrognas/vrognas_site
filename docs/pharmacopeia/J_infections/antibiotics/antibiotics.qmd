...
Antibacterials (@fig-antibiotic-classes) are drugs used to treat bacterial infections.
...
Antibiotics interfere with vital processes in bacterial cells.
They may kill the bacteria (bactericidal) or stop their growth (bacteriostatic).

### Bactericidal and bacteriostatic antibiotics

**Bactericidal** antibiotics kill bacteria.
**Bacteriostatic** antibiotics prevent bacteria from multiplying.
The immune system then clears the infection.

### Antibiotic targets in bacteria

Different classes of antibiotics act on different parts of bacterial cells.
They mainly target:
...
These structures do not exist in human or animal cells, so antibiotics typically do not harm our cells.
However, side effects can still occur.

![Types and classes of antibacterials.](images/antibiotic-classes.png){#fig-antibiotic-classes}

### Narrow-spectrum and broad-spectrum antibiotics

Some antibiotics have a **narrow** spectrum, meaning they act on only certain groups of bacteria.
Others are **broad** spectrum and affect many bacterial species.
Narrow-spectrum antibiotics are often preferred since they leave non-disease causing bacteria alone.
However, broad-spectrum antibiotics are sometimes used when doctors are unsure of the exact bacteria causing the infection.
...
Decided by plotting log-kill against AUC, and fitting a non-linear regression.

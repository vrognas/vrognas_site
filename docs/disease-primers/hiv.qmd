...
There are also two drugs, ritonavir (RTV) and cobicistat (COBI) which can be used as pharmacokinetic (PK) enhancers (or boosters) to improve the PK profiles of PIs and the INSTI elvitegravir (EVG).

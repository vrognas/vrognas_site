...
* [Pharmacodynamics](../../concepts/pd/index.qmd) --- the effect models being joined to the PK.
* [Time-to-event analysis](../tte/index.qmd) --- when the response is an event rather than a measurement.

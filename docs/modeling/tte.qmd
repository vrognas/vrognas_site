...
| Generalized log-logistic[@khanGeneralizedLoglogisticProportional2016] | $\frac{1}{1 + \lambda t^\gamma}$ | $\frac{\rho \gamma (\rho t)^{\gamma - 1}}{1 + (\lambda t)^\gamma}, 0 \le t, \gamma > 0$ | ✅ | ✅ |

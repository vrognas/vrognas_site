---
title: "Concentration-QTc (C-QTc) modeling"
description: "Concentration-QTc (C-QTc) analysis explained: the linear mixed-effects model for ΔQTcF used to assess a drug's effect on cardiac repolarization."
date: "2026-02-20"
---

For the regulatory context --- why ICH E14 requires this analysis, and when a standalone TQT study or a "double negative" waiver applies instead --- see [QT prolongation](../../concepts/clinpharm-studies/qt/index.qmd).

...
A parametric survival model is one in which the survival time (the outcome) is assumed to follow a known distribution, and the parameters of this distribution is modeled.
...
There are four approaches to modeling survival data with covariates^[[Rodríguez G. (2010)](https://grodri.github.io/survival/ParametricSurvival.pdf)]:
...
This can be modeled using a ETA in NONMEM, using the same approach as adding a covariate.
...
Drug classes on this site where a time-to-event analysis is the endpoint that decides the programme:

* [B01 Antithrombotic agents](../../pharmacopeia/b_blood-and-blood-forming-organs/b01_antithrombotic-agents/index.qmd) --- bleeding and thrombotic events carried separately from the PK.
* [L01 Antineoplastic agents](../../pharmacopeia/l_antineoplastic-and-immunomodulating-agents/l01_antineoplastic-agents/index.qmd) --- tumour-size metrics feeding a survival analysis.
* [N05 Psycholeptics](../../pharmacopeia/n_nervous-system/n05_psycholeptics/index.qmd) --- dropout hazard modelled jointly with the PANSS score.

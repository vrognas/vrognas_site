...
> The art of communicating effectively with AI systems
...
Consider the different factors involved, potential constraints, and various approaches before recommending the best solution. <!-- <6> -->
```
...
5. **Steps:** Guide the AI through multi-step reasoning
6. Asking the AI to **think first:** Give space for the AI to work through its process

::: {.callout-tip title="Gotcha"}

Giving examples in your prompt of what "good" looks like is sometimes called *few-shot* or *n-shot* prompting, where "n" is the number of examples given (e.g., three examples would be called "three-shot prompting").

Giving the AI step-by-step instructions is sometimes called "Chain of thought" (CoT) prompting.
:::

Force the model to say things out loud.

For lots of helpful tips and examples, see:
...
RAG keeps the model as-is and adds a **static** library.
...
MCP, just like RAG, keeps the model as-is, but adds a **dynamic** library.
It's a protocol for LLMs to communicate with external services and tools.

## Discernment

> Your ability to critically evaluate what AI produces, how it produces it, and how it behaves

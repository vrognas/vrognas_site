...
> The art of communicating effectively with AI
...
Consider the different factors involved, potential constraints, # <6>
and various approaches before recommending the best solution. # <6>
```

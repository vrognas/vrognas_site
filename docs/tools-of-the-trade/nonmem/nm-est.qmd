...
Like IMP, random samples are generated from normal proposal densities (@sec-imp).
...
Should usually be left to default (2).
5. `ISAMPLE_M1A`: Number of " 1A" iterations per `ISAMPLE`.
Should usually be left to default (0).
...
Should usually be left to default (0.4).

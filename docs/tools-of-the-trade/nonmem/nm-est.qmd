...
1. Once you have found good initial estimates (for THETA, OMEGA, and SIGMA) close to the global optimum, run the model again without `$ANNEAL` for better estimates.

...
1. Follow the Two-Pizza Rule. Keep meetings small enough to be fed by two pizzas (6-8 people).
2. Hold standing meetings. Studies show standing meetings reduce duration by 34%.
...
4. Keep one seat open at every meeting. This way, decisions will always consider the impact on the end user (h/t Amazon).
5. Use Al transcription tools to quickly capture key meeting points and action items.

...
3. Send a detailed agenda before the meeting.
State the purpose and desired outcomes for every attendee. No agenda means no meeting.
4. Keep one seat open at every meeting.
This way, decisions will always consider the impact on the end user.
5. Use AI transcription tools to quickly capture key meeting points and action items.
6. Implement Maker-Manager Schedules.
...
7. Use the 4-Bullet Update.
Update with 4 points: what was done, requested asks, current blockers, and future improvements.
Save hours in recurring meetings.

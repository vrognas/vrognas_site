...
$$
\CL_\text{pl} \times \Cpl = \CL_\text{bl} \times \Cbl
$$
...
$$
\mathrm{E_H} = \CL_\text{bl} / \mathrm{Q}
$$

$$
\CL_\mathrm{H} = \CL_\text{H, met} + \CL_\text{biliary}
$$

$$
\quad \CL_{\mathrm{H}, \text { blood }}=\frac{\mathrm{Q}_{\mathrm{H}} \times \mathrm{f}_{\mathrm{u} \text {,blood }} \times \CL_{\text {int }}}{\mathrm{Q}_{\mathrm{H}}+\mathrm{f}_{\mathrm{u}, \text { blood }} \times \CL_{\text {int }}}
$$

$$
\CL_{\mathrm{int}}=\sum_1^{\mathrm{i}} \frac{\mathrm{V}_{\mathrm{m}, \mathrm{i}}}{\mathrm{K}_{\mathrm{m}, \mathrm{i}}+\mathrm{C}_{\mathrm{u}}}
$$
...
$$
\CL_\mathrm{H} =
  E_H \times Q_H=\frac{Q_H \times C l_{\mathrm{int}} \times f u_b}{Q_H+C l_{\mathrm{int}} \times f u_b}
$$

$$
\F_\mathrm{H} = \frac{Q_H}{Q_H+C l_{\mathrm{int}} \times f u_b}
$$
...
$$
\CL_R =
  \mathrm{RBF} \times \mathrm{E} =
  \mathrm{GFR} \times \frac{\C_\text{in} - \C_\text{out}}{\C_\text{in}}
$$

$$
\CL_R =
  \frac{
    \text { rate of excretion }
  }{
...
\CL_R =
  ...
  \left[
    \frac{
      \text { Rate of secretion }- \text { Rate of reabsorption }
    }{
      \text { Plasma concentration }
    }
  \right]
...
$$
\CL_R = \frac{\text { Urine flow } \times \text { urine concentration }}{\text { Plasma concentration }}
$$


$\quad \CL_{\mathrm{R}}=\left[\CL_{\text {filtr }}+\CL_{\text {secr }}\right] \times\left(1-\mathrm{f}_{\text {reabs }}\right)$

$\CL_{\text {filtr }}=\mathrm{f}_{\mathrm{u}} \times \mathrm{GFR}$

Rate of excretion $=d A e / d t=($ Rate of filtration + Rate of secretion $) \times\left(1-f_{\text {reabs }}\right)=C L_R \times C$
...
\text{eGFR} =
  142 \times
  \text{min}(\frac{\text{SCr}}{K}, 1)^{\alpha} \times
  \text{max}(\frac{\text{SCr}}{K}, 1)^{-1.200} \times
  0.9938^{\text{Age}} \times
  1.012 [\text{if female}]
$$ {#eq-ckd-epi-2021}

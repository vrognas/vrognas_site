...
16. $\quad \CL_{\mathrm{R}}=\left[\CL_{\text {filtr }}+\CL_{\text {secr }}\right] \cdot\left(1-\mathrm{f}_{\text {reabs }}\right)$
17. $\CL_{\text {filtr }}=\mathrm{f}_{\mathrm{u}} \cdot \mathrm{GFR}$
18. Rate of excretion $=d A e / d t=($ Rate of filtration + Rate of secretion $) \cdot\left(1-f_{\text {reabs }}\right)=C L_R \cdot C$
19. $f_e=A_e /$ Dose $_{i v}=$ CL $_R / C L$

## Elimination rate (1-compartment case)

$$
t_\textonehalf = \frac{\ln 2}{k_e}
$$
...
$$
\Conc = \Conc_0 \cdot \mathrm{e}^{-\mathrm{k} \cdot \mathrm{t}}
$$
...
$$
\mathrm{E}_{\mathrm{H}}=\frac{C l_{\mathrm{int}} \cdot f u_b}{Q_H+C l_{\mathrm{int}} \cdot f u_b}
$$

$$
\CL_{\mathrm{H}}=E_H \cdot Q_H=\frac{Q_H \cdot C l_{\mathrm{int}} \cdot f u_b}{Q_H+C l_{\mathrm{int}} \cdot f u_b}
$$

$$
\mathrm{F}_{\mathrm{H}}=\frac{Q_H}{Q_H+C l_{\mathrm{int}} \cdot f u_b}
$$

$$
\mathrm{CL_R} = \mathrm{RBF} \cdot \mathrm{E}=\mathrm{GFR} \cdot \frac{\mathrm{C}_{\text {in }}-\mathrm{C}_{\text {out }}}{\mathrm{C}_{\mathrm{in}}}
$$
...
$$
\CL_{\text {ren }}=f u \cdot G F R+\left[\frac{\text { Rate of secretion }- \text { Rate of reabsorption }}{\text { Plasma concentration }}\right]
$$

$$
\mathrm{CL_R} = \frac{\text { Urine flow } \cdot \text { urine concentration }}{\text { Plasma concentration }}
$$

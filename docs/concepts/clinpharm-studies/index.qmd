...
Some study designs are driven by the drug class: for antibacterials, a preclinical dose-fractionation study gives the same total daily dose at different dosing intervals to find which PK/PD index governs the effect, as explained under [antibacterials](../../pharmacopeia/atc/j/j01/index.qmd#index-based-approaches).
...
* [Renal impairment (RI)](renal-impairment-studies/index.qmd) -- classified by GFR; required when f~e~ >30% (FDA), but even non-renally cleared drugs should consider severe RI. The mirror case, accelerated rather than reduced elimination, is [augmented renal clearance](../pk/augmented-renal-clearance/index.qmd).
...
* [Pediatrics](../pediatrics/index.qmd) -- required if seeking an adult indication (pediatric investigation plan / IPSP).
* Elderly
* Pregnant

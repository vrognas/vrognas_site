...
description: "How CDISC standards work for pharmacometrics — SDTM, ADaM, CDASH, and SEND — including the PC and EX domains you'll use to build population PK datasets."
date: "2026-02-22"
---
...
The studies whose concentration and dosing data arrive in the PC and EX domains described above:

* [First-in-human (FIH) studies](../fih/index.qmd) --- the first clinical source of SDTM PK data, and the cleanest.
* [Drug-drug interaction (DDI) studies](../ddi/index.qmd) --- object and precipitant designs, delivered in the same domains.
* [Bioavailability and bioequivalence](../ba-be/index.qmd) --- crossover designs, where period and sequence variables matter for ADaM derivation.
* [Mass balance / ADME studies](../mass-balance/index.qmd) --- radiolabelled excreta and metabolite data, which do not fit PC cleanly.
* [Clinical pharmacology studies](../index.qmd) --- how these studies fit across the development phases.

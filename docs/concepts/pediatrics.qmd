...
They have quite different physiology (@fig-small-adult), which must be taken into condsideration when evaluating PK and PD.

![A child and an adult human male scaled to the same height.](images/small-adult.png){#fig-small-adult}

Thi can be further visualized through how the relationship between the size of their head and the lengths of their arms is changing as the babies grow and become adults (See video below, credit: [dawnwalker_ on TikTok](https://www.tiktok.com/@dawnwalker_)).

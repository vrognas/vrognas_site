...
If you have ever felt uncomfortable with pharmacometric analysis in pediatric patients, this page is for you.
Let's walk through the basic concepts, so that you can confidently ask pointy questions during the next poster session.
...
So pat yourself on the back for not assuming this and thus being uncomfortable with your ignorance.
...
Video showing the difference in arm-length/head-size ratio between child and adult.
...
Where height is in cm, and SCr is in mg/dL.

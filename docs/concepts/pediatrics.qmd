...
This method of estimating the date of delivery is reliable as long as menstrual dates are remembered accurately (@fig-age-term; @tbl-age-term) [@committeeonfetusandnewbornAgeTerminologyPerinatal2004].
...
Age classifications are to some extent <span class="red-underline">**arbitrary**</span>, but a classification such as the one in @tbl-age-group provides a basis for thinking about study design.

...
Although surface-area-guided dosing might be preferred, measuring height or length---especially in infants and young children---is often prone to errors.
...
However, if required, you could consider estimating a higher sensitivity for children than adults.
That would mean decreasing the EC50 for an E-max model.
This would be a conservative approach to not overdose a pediatric patient.

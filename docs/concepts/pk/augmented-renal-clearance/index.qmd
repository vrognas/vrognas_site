...
Augmented renal clearance (ARC) is a term used when a patient's creatinine clearance (CrCL) exceeds 130 mL/min/1.73 m^2^.
...
Standard CrCL estimation equations like Cockcroft-Gault, MDRD, or CKD-EPI, are inaccurate at these high CrCL values.
...
Despite this, the underlying prognosis of patients with ARC is generally more favorable than that of patients with lower creatinine clearances.

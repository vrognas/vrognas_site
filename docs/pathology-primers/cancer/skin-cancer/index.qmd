...
* Non-melanoma skin cancer (NMSC)
  * **Basal-cell carcinoma (BCC)**
    ...
    * Grows slowly, rarely spreads to other parts of the body (metastasizes)
    * Low mortality
...
* Checkpoint inhibitors (immunotherapy)
  * PD-1 inhibitor
    * Nivolumab (Opdivo, L01FF01)
    * Pembrolizumab (Keytruda, L01FF02)
    * Cemiplimab (Libtayo, L01FF06)
  * PD-L1 inhibitor
    * Atezolizumab (Tecentriq, L01FF05)
  * CTLA-4 inhibitor
    * Ipilimumab (Yervoy, L01FX04)
